...
if (!defined('__CLASS_HTML2PDF__')) {
    ...
    class HTML2PDF
    {
        ...
        protected $_format           = 'latter';        // page format : A4, A3, ...
         ...
         */
        public function __construct($orientation = 'P', $format = 'latter', $langue='es', $unicode=true, $encoding='UTF-8', $marges = array(12, 8, 8, 10))
        {
